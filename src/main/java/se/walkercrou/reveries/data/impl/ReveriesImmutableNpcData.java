...
public final class ReveriesImmutableNpcData extends AbstractImmutableData<ImmutableNpcData, NpcData> implements ImmutableNpcData {
    ...
    public ReveriesImmutableNpcData(UUID ownerId, Text displayName, double sightRange, Set<NpcTrait> traits) {
